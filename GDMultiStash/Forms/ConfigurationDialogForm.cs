...
namespace GDMultiStash.Forms
{
    internal partial class ConfigurationDialogForm : DialogForm
    {
        ...
        private void UpdateAutoStartCommandList()
        {
            ...
            AddAutoStartCommand(_settings.StartGameCommand, _settings.StartGameArguments);
            AddAutoStartCommand("steam");
            AddAutoStartCommand("gog");
            AddAutoStartCommand("grimdawn");
            AddAutoStartCommand("griminternals");
            AddAutoStartCommand("grimcam");
        ...
        private void AddAutoStartCommand(string command, string args = "")
        {
